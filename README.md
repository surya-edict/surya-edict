...
<table>
  <tr>
    <td width="33%" valign="top">
      ...
      <p><strong>Core Idea</strong><br/>This project helps a team see AWS, Azure, and GCP cloud costs in one place instead of checking separate billing dashboards. It makes it easier to catch sudden spending spikes, understand where money is going, and find savings opportunities earlier.</p>
    ...
    <td width="33%" valign="top">
      ...
      <p><strong>Core Idea</strong><br/>This project uses a Netflix-style web app to show how a real frontend application moves from source code to production. It demonstrates the full flow of building the app, scanning it for issues, packaging it into containers, deploying it on Kubernetes, and monitoring it after release.</p>
    ...
    <td width="33%" valign="top">
      ...
      <p><strong>Core Idea</strong><br/>This project is a real inventory application for managing products, suppliers, orders, and stock levels. It also shows how that business app can be deployed on AWS, updated through automated pipelines, and monitored with alerts so the team knows about low stock or system issues before they become bigger problems.</p>
